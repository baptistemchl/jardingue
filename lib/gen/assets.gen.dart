...
class $AssetsDataGen {
  ...
  /// File path: assets/data/fruit_trees.json
  String get fruitTrees => 'assets/data/fruit_trees.json';

  /// File path: assets/data/plants.json
  String get plants => 'assets/data/plants.json';

  /// List of all assets
  List<String> get values => [fruitTrees, plants];
}
...
class $AssetsSplashGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [splash, splashAndroid12];
}
